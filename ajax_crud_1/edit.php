                    ...
                    <form action="javascript:void(0)" method="POST" id="myform">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" placeholder="First Name" value="<?php echo $data['fname']?? ''; ?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="">Last Name :</label>
                                <input type="text" name="last_name" placeholder="Last Name" value="<?php echo $data['lname']?? ''; ?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="">Email :</label>
                                <input type="email" name="email" placeholder="Email" value="<?php echo $data['email']?? ''; ?>" class="form-control">
                            </div>

                            <div class="form-group">
                                <label for="">Phone :</label>
                                <input type="phone" name="phone" placeholder="Phone" value="<?php echo $data['phone']?? ''; ?>" class="form-control">
                            </div>
